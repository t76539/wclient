...
class WClient extends Component {
    ...
    loadData() {
        ...
        // const url = "http://localhost:8080/weather?start=" + this.state.start + "&stop=" + this.state.end;
        const url = "http://localhost:8080/weather/compare/?start=" + this.state.start + "&stop=" + this.state.end;
